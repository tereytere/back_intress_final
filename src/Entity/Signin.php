...
class Signin
{
    ...
    #[ORM\Column(length: 255)]
    private ?string $timerestart = null;
    ...
    #[ORM\ManyToMany(targetEntity: Workshops::class, mappedBy: 'signin')]
    ...
    public function getTimerestart(): ?string
    {
        return $this->timerestart;
    }

    public function setTimerestart(string $timerestart): self
    {
