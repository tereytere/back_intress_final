...
class WorkshopsControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'workshop[date]' => 'Testing',
            'workshop[description]' => 'Testing',
            'workshop[signin]' => 'Testing',
            'workshop[holidays]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'workshop[date]' => 'Something New',
            'workshop[description]' => 'Something New',
            'workshop[signin]' => 'Something New',
            'workshop[holidays]' => 'Something New',
        ]);
